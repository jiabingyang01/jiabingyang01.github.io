...
<li>
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 5px;padding-left: px;">
    <img src="{{ link.image }}" class="teaser img-fluid z-depth-1" style="width: 110; height: 110; vertical-align: top;">
