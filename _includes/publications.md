...
<li>
<div class="pub-row">
  <!-- <div class="col-sm-3 abbr" style="position: relative;padding-right: 10px;padding-left: 0px;width: 120px; height: 60px;">
  ...
  <div class="teaser" style="float:left;width:40%;margin: 5px 10px 10px 0;"><img src="{{ link.image }}" height="110" style="box-shadow:2px 2px 6px #888888"/></div>
